                        ...
                        <div id="primary" class="content-area">
                            <main id="main" class="site-main">
                                <div class="homev6-slider-with-banners row">
                                    ...
                                    <!--  <a href="{{route('home')}}">Home</a> > Download -->
                                    <h3 style="color: red;">DOWNLOAD</h3>
                                    <h4 style="text-align: center;">Chọn tài liệu theo từng hãng có sẵn trong danh sách</h4>
                                                ...
                                                <div class="products">
                                                    ...
                                                    <div class="product"> 
                                                        <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                            <img src="{{url('uploads/download')}}/{{$cat->cover_image}}" class="wp-post-image " height="100px" alt="">
                                                        <h2 class="woocommerce-loop-product__title">{{$cat->content}}</h2>
                                                        </a>
                                                        <div class="hover-area">
                                                            <a class="button add_to_cart_button" href="" rel="nofollow">Xem chi tiết</a>   
                                                        </div>
                                                    </div>
                                                    @endforeach
                                                    <!-- /.product-outer -->
